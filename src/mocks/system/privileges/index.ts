...
import { nodes_audits, root_audits, tree_audits } from './audits'
import { nodes_docs, root_docs, tree_docs } from './docs'
import {
  nodes_exploiters,
  root_exploiters,
  tree_exploiters,
} from './exploiters'
import { nodes_files, root_files, tree_files } from './file-records'
import { nodes_logs, root_logs, tree_logs } from './logs'
import { nodes_messages, root_messages, tree_messages } from './messages'
import { nodes_regions, root_regions, tree_regions } from './regions'
import {
  nodes_schedulers,
  root_schedulers,
  tree_schedulers,
} from './schedulers'
import { nodes_system, root_system, tree_system } from './system'
