        ...
        <q-form @submit="onSubmit">
          ...
          <q-card-section>
            <div class="row flex-center q-gutter-md">
              <q-img
                v-if="row.contentType && row.contentType.includes('image')"
                :src="row.path"
              />
            ...
            <div class="q-gutter-md q-mt-md">
              ...
              <p
                ><strong>{{ $t("label.size") }}</strong>
                {{ humanStorageSize(row.size) }}
              </p>
              <p
                ><strong>{{ $t("label.contentType") }}</strong>
                {{ row.contentType }}
              </p>
              <p
                ><strong>{{ $t("label.lastModifiedDate") }}</strong>
                {{
                  row.lastModifiedDate
                    ? date.formatDate(row.lastModifiedDate, "YYYY-MM-DD HH:mm")
                    : "-"
                }}
              </p>
            </div>
                ...
                <template v-else-if="props.row.regularFile">
                  <q-icon
                    v-if="
                      ...
                      props.row.contentType.includes('image')
                    "
                    name="sym_r_image"
                  />
