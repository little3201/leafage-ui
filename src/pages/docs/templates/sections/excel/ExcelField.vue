...
import { createSectionField, modifySectionField, removeSectionField, retrieveSectionFields } from '@/api/docs/sections'
...
<template>
  <ElForm ref="formRef" :model="{ fields }" :show-message="false">
