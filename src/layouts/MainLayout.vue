...
<template>
  <ElHeader
    class="fixed top-0 left-0 right-0 flex flex-nowrap bg-(--el-color-primary) z-10"
  >
          ...
          <template #dropdown>
            ...
            <ElDropdownMenu>
              <RouterLink to="/profile" class="no-underline">
                <ElDropdownItem>
                  <Icon
                    :icon="loadIcon(globalIcons['profile'])"
                    width="1.5em"
                    height="1.5em"
                    class="mr-2"
                  />
              ...
              <RouterLink to="/faq" class="no-underline">
                <ElDropdownItem>
                  <Icon
                    :icon="loadIcon(globalIcons['help'])"
                    width="1.5em"
                    height="1.5em"
                    class="mr-2"
                  />
              ...
              <ElDropdownItem divided @click="logout">
                <Icon
                  :icon="loadIcon(globalIcons['logout'])"
                  width="1.5em"
                  height="1.5em"
                  class="mr-2"
                />
